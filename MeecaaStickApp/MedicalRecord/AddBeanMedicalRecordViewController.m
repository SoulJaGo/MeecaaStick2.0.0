//
//  AddBeanMedicalRecordViewController.m
//  MeecaaStickApp
//
...
#import "AddBeanMedicalRecordViewController.h"
...
@interface AddBeanMedicalRecordViewController ()<UITextFieldDelegate,UIActionSheetDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
...
@implementation AddBeanMedicalRecordViewController
...
- (void)onClickSave {
    ...
    [[HttpTool shared] addDiaryWithDate:timeStr Temperature:self.temperatureLabelCell.temperatureTextField.text Symptoms:[NSString stringWithFormat:@"%d",symptomInt] Photo_count:0 Description:desc Member_id:defaultMemberId Longitude:[NSString stringWithFormat:@"%f",[[GlobalTool shared] longitude]] Latitude:[NSString stringWithFormat:@"%f",[[GlobalTool shared] latitude]]];
}
